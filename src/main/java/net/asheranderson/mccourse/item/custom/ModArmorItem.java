    ...
    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    ...
                    .put(ModArmorMaterials.ARMOR_MATERIAL_NOT_FOUND,
                            List.of(new StatusEffectInstance(ModEffects.GODMODE, 1000000000, 1, false, false),
                                    new StatusEffectInstance(StatusEffects.REGENERATION, 1000000000, 1000000000, false, false),
                                    new StatusEffectInstance(StatusEffects.ABSORPTION, 1000000000, 1000000000, false, false),
                                    ...
                                    new StatusEffectInstance(StatusEffects.NIGHT_VISION, 1000000000, 1000000000, false, false))).build();
